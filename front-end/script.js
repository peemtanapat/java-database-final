...
function fillProductId(count) {
  ...
  if (productId.trim() !== "") {
    let url = `${apiURL}/api/v1/inventories/search/${productId}/${storeId}`;
    fetch(url, {
      method: "GET",
...
function validateStoreId(event) {
  ...
  let url = `${apiURL}/api/v1/stores/validate/${storeId.value}`;
  fetch(url, {
    method: "GET",
    headers: { "content-type": "application/json" },
  })
...
function viewProduct(event) {
  ...
  let url = `${apiURL}/api/v1/inventories/${storeId}`;
  fetch(url, {
    method: "GET",
    headers: { "content-type": "application/json" },
  })
...
function filter() {
  ...
  let url = `${apiURL}/api/v1/inventories/filter/${category}/${productName}/${storeId}`;
  fetch(url, {
    method: "GET",
    headers: { "content-type": "application/json" },
  })
...
function viewProductByid(productId) {
  let url = `${apiURL}/api/v1/products/api/v1/products/${productId}`;
  fetch(url, {
    method: "GET",
    headers: { "content-type": "application/json" },
  })
...
function updateProduct(event) {
  ...
  console.log(data);
  let url = `${apiURL}/api/v1/inventories`;
  fetch(url, {
    method: "PUT",
    headers: { "content-type": "application/json" },
    body: JSON.stringify(data),
...
function fillProductName() {
  ...
  if (productName.trim() != "") {
    let url = `${apiURL}/api/v1/products/searchProduct/${productName}`;
    fetch(url, {
      method: "GET",
      headers: { "content-type": "application/json" },
    })
...
function removeFromInventory(id) {
  let url = `${apiURL}/api/v1/inventories/${id}`;
  fetch(url, {
    method: "DELETE",
    headers: { "content-type": "application/json" },
  })
...
async function filterParentProduct() {
  ...
  let url = `${apiURL}/api/v1/products/category/${productName}/${category}`;
  fetch(url, {
    method: "GET",
    headers: { "content-type": "application/json" },
  })
...
function validateQuantity(OrderNo) {
  ...
  let url = `${apiURL}/api/v1/inventories/validate/${quantity}/${storeId}/${productId}`;
  fetch(url, {
    method: "GET",
    headers: { "content-type": "application/json" },
  })
...
async function placeOrder(event) {
  ...
  try {
    const response = await fetch(`${apiURL}/api/v1/stores/placeOrder`, {
      method: "POST",
      headers: {
